...
class UIApplicationEx: UIApplication {
    override internal var userInterfaceLayoutDirection: UIUserInterfaceLayoutDirection
        ...
        get
        {
            let lang:String = NSUserDefaults.standardUserDefaults().arrayForKey("AppleLanguages")!.first as! String
            //print("LANG :: ", lang);
            if( lang == "Base" ){
                return .LeftToRight;
            }else{
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        object_setClass(application,UIApplicationEx.self);
        return true
    }
    ...
    func changeLanguage(){
        ...
        if( lang == "Base"  ){
            ...
            defaults.setObject(["Base"], forKey: "AppleLanguages");
            defaults.synchronize();
            
            NSBundle.setLanguage("Base")
        }
        
        
        
        let story = UIStoryboard(name: "Main", bundle: nil);
        let vc = story.instantiateViewControllerWithIdentifier("VC");
